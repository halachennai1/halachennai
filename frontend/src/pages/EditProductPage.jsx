...
const EditProductPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    regularSize: product.regularSize || false,
    kidSize: product.kidSize || false,
    customizable: product.customizable || false,
    shoeSize: product.shoeSize || false,
    images: allImages || [],
  });
      ...
      reader.onloadend = () => {
        if (e.target.name === "mainImage") {
          ...
          setNewImages((prevImages) => [
            ...
            reader.result,
          ]); // Add the additional image to the array
        }
      };
  ...
  const handleSaveChanges = async () => {
    if (!formData.name || !formData.price || !formData.category) {
      ...
      try {
        ...
        regularSize: formData.regularSize,
        kidSize: formData.kidSize,
          ...
          <form>
            ...
            <div className="mb-4 flex items-center space-x-2">
              <input
                type="checkbox"
                name="kidSize"
                checked={formData.kidSize}
                onChange={handleInputChange}
                className="text-black"
              />
              <label className="text-gray-800 font-medium mb-2">Kid Size</label>
            </div>
